...
--> Found Docker image f001b13 (8 months old) from Docker Hub for "veermuchandi/welcome"
    ...
    * WARNING: Image "veermuchandi/welcome" runs as the 'root' user which may not be permitted by your cluster administrator
...
````
$ curl http://welcome.UserName.<<DomainNameSuffix>>
